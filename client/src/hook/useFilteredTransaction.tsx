...
export const useFilteredTransaction = (transactions: QueryTransaction[]) => {
  const [targetStartDate, setTargetStartDate] = useState<Date | null>(() => getStartOfMonth(),);
  const [targetEndDate, setTargetEndDate] = useState<Date | null>(() => getEndOfMonth(),);
  ...
  const filteredTransactions = useMemo(() => {
    ...
    const sortFilteredTransactions = useMemo(() => {
